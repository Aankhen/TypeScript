...
namespace ts.formatting {
    ...
    export function getAllRules(): RuleSpec[] {
        ...
        const userConfigurableRules = [
            ...
            // Insert space after function keyword for anonymous generator functions
            rule("SpaceAfterAnonymousGeneratorAsterisk", SyntaxKind.AsteriskToken, SyntaxKind.OpenParenToken, [isOptionEnabled("insertSpaceAfterFunctionKeywordForAnonymousFunctions"), isFunctionDeclContext], RuleAction.Space),
            rule("NoSpaceAfterAnonymousGeneratorAsterisk", SyntaxKind.AsteriskToken, SyntaxKind.OpenParenToken, [isOptionDisabledOrUndefined("insertSpaceAfterFunctionKeywordForAnonymousFunctions"), isFunctionDeclContext], RuleAction.Delete),
